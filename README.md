# wiki-search-redis-cached
Ejemplo de uso de cache con un redis
# POC DE CACHE CON REDIS

Se consume api de wikipedia para sumar tiempo de carga, respuesta con mismos parametros son guardados en redis.

Ej :
http://localhost:8081/wiki/Chile
